To run FindMisplacedTests.py, please specify the first the parameter as the absolute path of the directory where the project is located at and the second parameter as the project name.
